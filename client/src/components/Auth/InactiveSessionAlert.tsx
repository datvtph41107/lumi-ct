...
const progressWrap: React.CSSProperties = { width: '100%', height: 6, background: '#eee', borderRadius: 999, overflow: 'hidden' };
		...
		<div style={overlayStyle}>
			<div style={modalStyle}>
				...
				<div style={actionsStyle}>
					...
					<button onClick={() => { setIsLoggingOut(true); onLogout(); }} disabled={isLoggingOut} style={{ padding: '8px 12px' }}>
