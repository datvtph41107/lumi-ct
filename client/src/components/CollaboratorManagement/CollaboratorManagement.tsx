...
const CollaboratorManagement: React.FC<CollaboratorManagementProps> = ({ contractId, currentUserId }) => {
    ...
    const filteredCollaborators = collaborators.filter((collab) => {
        if (searchTerm) {
            return (
                collab.user_name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
        ...
        <div className={cx('collaborator-management')}>
            ...
            <div className={cx('header')}>
                ...
                {permissions?.permissions.can_manage_collaborators && (
                    <button className={cx('add-btn')} onClick={() => setShowAddForm(true)}>
            ...
            {permissions?.permissions.can_transfer_ownership && (
                <div className={cx('transfer-ownership')}>
                    <button className={cx('transfer-btn')} onClick={() => setShowTransferOwnership(true)}>
                ...
                <div className={cx('activity-list')}>
                    {recentActivity.map((activity) => (
                        <div key={activity.id} className={cx('activity-item')}>
                            <div className={cx('activity-icon')}>{auditLogService.getActionIcon(activity.action)}</div>
                ...
                <div className={cx('modal-overlay')}>
                    <div className={cx('modal')}>
                        <div className={cx('modal-header')}>
                            ...
                            <button className={cx('close-btn')} onClick={() => setShowAddForm(false)}>
                                ×
                            </button>
                        </div>
                ...
                <div className={cx('modal-overlay')}>
                    <div className={cx('modal')}>
                        <div className={cx('modal-header')}>
                            ...
                            <button className={cx('close-btn')} onClick={() => setEditingCollaborator(null)}>
                                ×
                            </button>
                        </div>
                ...
                <div className={cx('modal-overlay')}>
                    <div className={cx('modal')}>
                        <div className={cx('modal-header')}>
                            ...
                            <button className={cx('close-btn')} onClick={() => setShowTransferOwnership(false)}>
                                ×
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleTransferOwnership} className={cx('modal-form')}>
                            ...
                            <div className={cx('form-group')}>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setTransferData({ ...transferData, to_user_email: e.target.value })
                                    }
                                    required
                                />
                            </div>
