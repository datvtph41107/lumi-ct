...
export class ContractTemplateService extends BaseService {
    ...
    async createContractTemplate(template: Omit<ContractTemplate, "id" | "createdAt" | "updatedAt">): Promise<ApiResponse<ContractTemplate>> {
        return this.request.private.post<ContractTemplate, Omit<ContractTemplate, "id" | "createdAt" | "updatedAt">>("/contracts/templates", template);
    }
