...
type ApiClientRequestMethods = {
    ...
    post: <TResponse, TBody = unknown>(url: string, data?: TBody, options?: { headers?: Record<string, string> }) => Promise<ApiResponse<TResponse>>;
    put: <TResponse, TBody = unknown>(url: string, data?: TBody, options?: { headers?: Record<string, string> }) => Promise<ApiResponse<TResponse>>;
    patch: <TResponse, TBody = unknown>(url: string, data?: TBody, options?: { headers?: Record<string, string> }) => Promise<ApiResponse<TResponse>>;
...
export abstract class BaseService {
    ...
    protected async get<TResponse, TParams = unknown>(path: string, params?: TParams, client: "public" | "private" = "private"): Promise<ApiResponse<TResponse>> {
    ...
    protected async delete<TResponse>(path: string, client: "public" | "private" = "private"): Promise<ApiResponse<TResponse>> {
        const url = this.joinPath(path);
