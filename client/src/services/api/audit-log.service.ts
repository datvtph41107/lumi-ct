...
export class AuditLogService extends BaseService {
    ...
    async getContractAuditSummary(contractId: string): Promise<ApiResponse<AuditLogSummary>> {
        return this.request.private.get<AuditLogSummary>(`${this.baseUrl}/${contractId}/audit/summary`);
    }
    ...
    async getActivityByDateRange(contractId: string, dateFrom: string, dateTo: string): Promise<AuditLog[]> {
        try {
