...
export const AUDIT_ACTION_CATEGORIES = {
    ...
    STAGE_MANAGEMENT: [
        AUDIT_ACTIONS.SAVE_STAGE,
        AUDIT_ACTIONS.TRANSITION_STAGE,
        AUDIT_ACTIONS.AUTO_SAVE,
    ],
    ...
    VERSION_MANAGEMENT: [
        AUDIT_ACTIONS.CREATE_VERSION,
        AUDIT_ACTIONS.PUBLISH_VERSION,
        AUDIT_ACTIONS.ROLLBACK_VERSION,
    ],
    ...
    APPROVAL_WORKFLOW: [
        AUDIT_ACTIONS.APPROVE_CONTRACT,
        AUDIT_ACTIONS.REJECT_CONTRACT,
        AUDIT_ACTIONS.REQUEST_CHANGES,
    ],
    TEMPLATE_MANAGEMENT: [
    ...
    NOTIFICATION_MANAGEMENT: [
        AUDIT_ACTIONS.CREATE_NOTIFICATION,
        AUDIT_ACTIONS.CREATE_REMINDER,
    ],
    EXPORT_ACTIONS: [
        AUDIT_ACTIONS.EXPORT_PDF,
        AUDIT_ACTIONS.EXPORT_DOCX,
        AUDIT_ACTIONS.PRINT_CONTRACT,
    ],
} as const;
