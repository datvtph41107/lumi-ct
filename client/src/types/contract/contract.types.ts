...
export interface BasicTemplateStructure {
    templateid: string;
    name: string;
    description?: string;
    version?: number;
...
export interface BasicFormContractData extends BaseContractData {
    mode: 'basic';
    content?: { mode: 'basic'; templateId?: string; fieldValues?: Record<string, unknown>; description?: string };
}
export interface EditorContractData extends BaseContractData {
    mode: 'editor';
    content?: { mode: 'editor'; editorContent: EditorContent };
}
export interface UploadContractData extends BaseContractData {
    mode: 'upload';
    content?: { mode: 'upload'; uploadedFile: UploadedFile; editorContent: EditorContent };
}
...
export interface ContractStructure {
    form?: BasicTemplateStructure;
    editor?: EditorTemplateStructure;
}
