...
export class AuthCoreService {
    ...
    getContractPermissions(): Permission[] {
        ...
        return userPermissions.permissions.filter((permission) => permission.resource === 'contract');
    }
    ...
    getDashboardPermissions(): Permission[] {
        ...
        return userPermissions.permissions.filter((permission) => permission.resource === 'dashboard');
    }
    ...
    getTemplatePermissions(): Permission[] {
        ...
        return userPermissions.permissions.filter((permission) => permission.resource === 'template');
    }
    ...
    getAuditPermissions(): Permission[] {
        ...
        return userPermissions.permissions.filter((permission) => permission.resource === 'audit');
    }
}
