...
export const ContractManagerGuard: React.FC<{
	...
	<RoleGuard role="contract_manager" fallback={fallback}>{children}</RoleGuard>
);
...
export const AccountingStaffGuard: React.FC<{
	...
	<RoleGuard role="accounting_staff" fallback={fallback}>{children}</RoleGuard>
);
...
export const HRStaffGuard: React.FC<{
	...
	<RoleGuard role="hr_staff" fallback={fallback}>{children}</RoleGuard>
);
