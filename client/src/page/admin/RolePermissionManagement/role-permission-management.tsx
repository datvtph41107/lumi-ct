    ...
    return (
        <div style={{ padding: 24 }}>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
                ...
                <button
                    onClick={() => setSelected({ id: '', name: '', displayName: '', description: '', priority: 1 })}
                >
                    + Tạo role
                </button>
            </div>
                        ...
                        {selected ? (
                            <div style={{ display: 'grid', gap: 12 }}>
                                ...
                                <div style={{ display: 'flex', gap: 8 }}>
                                    <button disabled={saving} onClick={onSaveRole}>
                                            ...
                                            <tr key={i} style={{ borderTop: '1px solid #eee' }}>
                                                ...
                                                <td>
                                                    <input
                                                        ...
                                                        value={p.conditions ? JSON.stringify(p.conditions) : ''}
                                                        onChange={(e) => {
                                                            try {
                                ...
                                <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                                    <button
                                        onClick={() =>
                                            setPerms([
                                                ...perms,
                                                {
                                                    resource: catalog.resources[0] || 'contract',
                                                    action: catalog.actions[0] || 'read',
                                                },
                                            ])
                                        }
                                    >
                                    ...
                                    <button disabled={saving} onClick={onSavePerms}>
