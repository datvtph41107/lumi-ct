...
const StageMilestones: React.FC = () => {
    ...
    const getPriorityClass = (priority: string) =>
        cx('badge', `priority${priority.charAt(0).toUpperCase() + priority.slice(1)}`);
                                ...
                                defaultValues={
                                    editingMilestone
                                        ? {
                                              ...
                                              assignee:
                                                  employees.find((emp) => emp.label === editingMilestone.assignee)
                                                      ?.value || '',
                                          }
                                    ...
                                    {milestones.map((milestone, index) => (
                                        <div key={milestone.id} className={cx('timelineItem')}>
                                            {index < milestones.length - 1 && (
                                                <div className={cx('timelineConnector')} />
                                            )}
                                                        ...
                                                        <div className={cx('timelineTasks')}>
                                                            ...
                                                            {milestone.tasks.map((task) => (
                                                                <div key={task.id} className={cx('timelineTask')}>
                                                                    ...
                                                                    {task.description && (
                                                                        <p className={cx('taskDescription')}>
                                                                            {task.description}
                                                                        </p>
                                                                    )}
