...
import type { ContractTemplate, TemplateField, TemplateSection } from '~/types/contract/contract.types';
...
const TemplateManagement: React.FC<TemplateManagementProps> = ({ mode, onSelect }) => {
    ...
    const getCategoryDisplayName = (category: string) => {
        switch (category) {
            ...
            case 'business':
                return 'Hợp đồng kinh doanh';
            case 'service':
                return 'Hợp đồng dịch vụ';
            case 'rental':
                return 'Hợp đồng thuê mướn';
            default:
                return category;
        }
    };
                        ...
                        <div key={template.id} className={cx('template-card')}>
                            ...
                            <div className={cx('template-info')}>
                                ...
                                <div className={cx('template-meta')}>
                                    <span className={cx('category')}>{getCategoryDisplayName(template.category)}</span>
                                    <span className={cx('type')}>{getTypeDisplayName(template.type)}</span>
                                    {template.is_public && (
                                ...
                                {onSelect && (
                                    <button className={cx('select-btn')} onClick={() => onSelect(template)}>
                        ...
                        >
                            ...
                            {formData.type === 'basic' && (
                                <div className={cx('form-section')}>
                                    ...
                                    <button type="button" className={cx('add-field-btn')} onClick={addField}>
                                        <FontAwesomeIcon icon={faPlus} />
                                        Thêm trường
                                    </button>
                                </div>
                ...
                <div className={cx('modal-overlay')}>
                    <div className={cx('modal', 'preview-modal')}>
                        <div className={cx('modal-header')}>
                            ...
                            <button className={cx('close-btn')} onClick={() => setPreviewTemplate(null)}>
                                <FontAwesomeIcon icon={faTimes} />
                            </button>
                        </div>
