            ...
            <div className={cx('header')}>
                ...
                <div className={cx('header-right')}>
                    <div className={cx('view-controls')}>
                        ...
                        <button
                            className={cx('view-button', { active: viewMode === 'grid' })}
                        ...
                        <button
                            className={cx('view-button', { active: viewMode === 'list' })}
                        ...
                        <div className={cx('templates-grid')}>
                            ...
                            {filteredTemplates.slice(0, 6).map((template) => (
                                ...
                                >
                                    <div className={cx('template-preview')}>
                                        <img
                                            src={`/placeholder_svg.png?height=120&width=90&text=${encodeURIComponent(
                                                template.name,
                                            )}`}
                                            alt={template.name}
                                    ...
                                    <div className={cx('template-subtitle')}>
                                        {getContractTypeDisplay(template.contractType)}
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className={cx('section-header')}>
                        ...
                        <div className={cx('section-filters')}>
                            <Dropdown
                                ...
                                onChange={(value) =>
                                    setFilters((prev) => ({ ...prev, contractType: value as ContractCreationMode }))
                                }
                                ...
                                <div key={draft.id} className={cx('document-card')}>
                                    <div className={cx('document-preview')}>
                                        ...
                                        <div className={cx('document-overlay')}>
                                            ...
                                            <button
                                                className={cx('overlay-button', 'delete')}
                                    ...
                                    <div className={cx('document-info')}>
                                        <div className={cx('document-header')}>
                                            ...
                                            <div className={cx('document-meta')}>
                                                ...
                                                <p className={cx('document-date')}>
                                                    Đã mở {formatDate(draft.updatedAt)}
                                                </p>
                                            </div>
                                        ...
                                        <div className={cx('document-details')}>
                                            <span className={cx('document-type')}>
                                                {getModeDisplay(draft.contractData.content.mode)}
                                            </span>
                                            {getDraftProgress(draft) < 100 && (
                                                <span className={cx('document-status')}>
                                                    {getDraftProgress(draft)}% hoàn thành
                                                </span>
                                            )}
                                        </div>
                                    </div>
