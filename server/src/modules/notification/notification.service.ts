...
export class NotificationService {
    async create(input: { type: NotificationType; title: string; message: string; data?: string; userId: number; started_at?: Date; ended_at?: Date; }): Promise<{ id: string }>{
    ...
    async notifyManyUsers(opts: { userIds: number[]; type: NotificationType; title: string; message: string; data?: string; startedAt?: Date; endedAt?: Date; }): Promise<void> {
